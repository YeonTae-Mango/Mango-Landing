  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex justify-between items-center px-8 py-6 bg-white">
        ...
        <div className="flex gap-8 text-gray-700"></div>
      </nav>
        ...
        <div className="relative z-10 container mx-auto px-10 pt-50">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-white mb-6">
              ...
              <br />더 이상 겉모습만 보고 판단하지 마세요.
            </p>

            <a
              href="/app.apk"
              download="mango.apk"
              className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white px-10 py-4 rounded-full text-lg font-bold transition-all transform hover:scale-105 shadow-lg inline-flex items-center gap-3 no-underline mb-4"
            >
              <Download size={24} />
              mango 설치하기
            </a>

            <p className="text text-white/50 mb-6">* 안드로이드에서만 다운로드 가능합니다.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-8">
          <div className="flex items-center gap-8">
            ...
            <div className="flex-1">
              ...
              <h2 className="text-4xl font-bold mb-6 text-gray-800">카테고리별 스와이프</h2>
      ...
      <section className="py-20" style={{ backgroundColor: "#FF6D60" }}>
        <div className="container mx-auto px-8">
          <div className="flex items-center gap-12">
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative">
                <img src="/assets/chat.png" alt="채팅" className="w-80 object-cover rounded-[2.5rem] shadow-2xl" />
              </div>
            </div>
          </div>
        </div>
